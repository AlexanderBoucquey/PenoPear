...
figure
[xinumeriek,yi] = meshgrid(0:0.001:0.06, -0.05:0.001:0.05);
zinumeriek = griddata(p(:,1),p(:,2),C_u0,xinumeriek,yi);
surf(xinumeriek,yi,zinumeriek);

% Plot lineaire oplossing dioxide
figure
[xi,yi] = meshgrid(0:0.001:0.05, -0.05:0.001:0.1);
...
figure
[xi,yi] = meshgrid(0:0.001:0.05, -0.05:0.001:0.05);
zi = griddata(p(:,1),p(:,2),C_u,xi,yi);
surf(xi,yi,zi);
...
figure
semilogy(r,Cu_analytic,xinumeriek(1,:),zinumeriek(51,:)),legend('analytisch','numeriek');
xlabel('Straal r');
ylabel('Concentratie Oxide');
print('Refrigerator_sphere_O2_analytical','-dpng');